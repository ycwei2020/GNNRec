...
def main():
    # Training settings
    parser = argparse.ArgumentParser(description='Social Recommendation: GNNRec model')
    ...
    # model
    gnnrec = GNNRec(enc_u, enc_v_history, r2e).to(device)
    optimizer = torch.optim.RMSprop(gnnrec.parameters(), lr=args.lr, alpha=0.9)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train(gnnrec, device, train_loader, optimizer, epoch, best_rmse, best_mae)
        expected_rmse, mae = tes(gnnrec, device, test_loader)
